const ButtonCursorIcon = ({ className, ...props }) => (
  <svg
  ...
  >
    <g fill="none">
      ...
      />
      <defs>
        <linearGradient id="btn_g0" x1="12" y1="3" x2="12" y2="13" gradientUnits="userSpaceOnUse">
          <stop stopColor="#575757" />
          <stop offset="1" stopColor="#151515" />
        </linearGradient>
        <linearGradient id="btn_g1" x1="8.665" y1="8.664" x2="18.672" y2="18.67" gradientUnits="userSpaceOnUse">
          <stop stopColor="#E3E3E5" stopOpacity=".6" />
          <stop offset="1" stopColor="#BBBBC0" stopOpacity=".6" />
        </linearGradient>
        <linearGradient id="btn_g2" x1="15.546" y1="8.149" x2="15.546" y2="15" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff" stopOpacity="1" />
          <stop offset="1" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <filter id="btn_blur" x="-100%" y="-100%" width="400%" height="400%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse">
          <feGaussianBlur stdDeviation="2" x="0%" y="0%" width="100%" height="100%" in="SourceGraphic" edgeMode="none" result="blur" />
        </filter>
        <clipPath id="btn_clip">
          <path d="M8.24247 10.4549C7.78665 9.08694 9.08838 7.78521 10.4563 8.24103L21.7466 12.0044C23.319 12.5289 23.3487 14.7428 21.7907 15.3093L17.0385 17.037L15.3108 21.7893C14.7442 23.3473 12.5304 23.3176 12.0059 21.7451L8.24247 10.4549Z" />
        </clipPath>
        <mask id="btn_mask">
...
export default ButtonCursorIcon;
